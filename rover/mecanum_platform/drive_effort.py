class DriveEffort:
    ...
    def __add__(self, o):
        ...
        return DriveEffort(fl, fr, bl, br)
    ...
    def clamp(self):
        ...
        self.effort_fl = clamp_effort(self.effort_fl)
        self.effort_fr = clamp_effort(self.effort_fr)
        self.effort_bl = clamp_effort(self.effort_bl)
        self.effort_br = clamp_effort(self.effort_br)
